   ...
   <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
    <div class="container">
        <div class="d-sm-flex flex-sm-row-reverse align-items-center">
                        <img src="https://images.unsplash.com/photo-1579975735515-38b76c8c772c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1NzE0OTYzfDB8MXxzZWFyY2h8MTF8fGJhZG1pbnRvbiUyMGJhbm5lcnxlbnwwfHx8fDE3MDQ1OTIzMDB8Mg&ixlib=rb-4.0.3&q=80&w=300*&v=1*" class="img-fluid" width="300" alt="Banner Badminton">
            <div>
                <h1 class="fw-bold display-4">UKM Bulutangkis UDINUS: Pusat Informasi, Jadwal, dan Prestasi Klub.</h1>
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4 justify-content-center"></div>
        ...
        <!------------------- col begin-------------->
            <div class="col">
             ...
             <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTi17Q8cKkQj6WnSceSA517Zfad7_9MHA6Fsw&amp;s"  class="card-img-top" alt="Pemain Badminton UDINUS">
...
<!--------------------article end----------------------------->
    ...
    <section id="gallery" class="text-center p-5 bg-danger-subtle">
        <div class="container">
            ...
            <div id="carouselExample" class="carousel slide mx-auto" style="max-width: 450px;">
                <div class="carousel-inner rounded shadow">
                                        <div class="carousel-item active">
                        <img src="https://images.unsplash.com/photo-1543781989-43c3d5512b9d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1NzE0OTYzfDB8MXxzZWFyY2h8MXx8YmFkbWludG9uJTIwZ2FtZXxlbnwwfHx8fDE3MDQ1OTIwNTJ8Mg&ixlib=rb-4.0.3&q=80&w=450*&v=5*" class="d-block w-100" alt="Pemain Bulutangkis Bertanding">
                    </div>
                                        <div class="carousel-item">
                        <img src="https://images.unsplash.com/photo-1623354394411-e6347309995c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1NzE0OTYzfDB8MXxzZWFyY2h8Mnx8YmFkbWludG9uJTIwcHJhY3RpY2V8ZW58MHx8fHwxNzA0NTkyMDUyfDI&ixlib=rb-4.0.3&q=80&w=450*&v=6*" class="d-block w-100" alt="Pemain Bulutangkis Latihan Fisik">
                    </div>
                                        <div class="carousel-item">
                        <img src="https://images.unsplash.com/photo-1599368364843-f66d5b072d62?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1NzE0OTYzfDB8MXxzZWFyY2h8NHx8YmFkbWludG9uJTIwY291cnR8ZW58MHx8fHwxNzA0NTkyMDUyfDI&ixlib=rb-4.0.3&q=80&w=450*&v=7*" class="d-block w-100" alt="Lapangan Bulutangkis">
                    </div>
                </div>
